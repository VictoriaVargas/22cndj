				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-6">
									<h3 class="text-center text-primary text-bold">¡¡Felicidades Director :<?= $director->nombre ?> !!</h3>
									<table class="table table-striped margin-top-20">
										<tr>
											<td align="center"><img src="<?= base_url()?>assets/img/logo.jpg" width="100px"></td>
										</tr>
										<tr>
											<td>Sede: <span class="text-bold text-primary"><?= $director->nombre_sede ?></span></td>
										</tr>

										<tr>
											<td>Grupo: <span class="text-bold text-primary"><?= $director->academia ?></span></td>
										</tr>	
										<tr>
											<td>Fecha Registro: <span class="text-bold text-primary"><?= $director->fecha_registro ?></span></td>
										</tr>																				
									</table>
								</div>
								<div class="col-md-6">
									<table class="table table-striped">
										<tr>
											<td align="center" colspan="2">
												<h4 class="text-primary">Guarda estos QR en tu teléfono o computadora para mostrarlo el dia del registro, esto facilitará el proceso.</h4>
											</td>
										</tr>
											...
											<?php foreach ($alumnos->result() as $alumno){?>
												<tr>
													<td align="center" width="130px">
														<img src="<?= base_url()?>assets/qr/<?= $alumno->token_qr?>.png" width="100px">
													</td>
													<td class="text-primary"><?= $alumno->nombre." ".$alumno->paterno." ".$alumno->materno?></td>	
												</tr>
											<?php } 
												} ?>
										...
										<tr>
											<td align="center" colspan="2">											
												<a class="btn btn-wide btn-primary" target="_blank" href="<?= base_url()?>inicio/comprobanteDirector/<?= $token?>" ><i class="fa fa-save"></i> Guardar comprobante</a>												
