...
<table border="0" align="center">
	<tr>
		<td>Número:  <span class="text-primary"><?= $alumno->numero." "; ?></span></td>
		<td align="center" rowspan="6" class="border">
	...
	<tr>
		<td>KIT: <span class="text-primary"><? echo ($alumno->numero>=184)?"NO":"SI";?></span></td>
	</tr>
	<tr>
		<td>Talla: <span class="text-primary"><?= $alumno->talla_playera ?></span></td>
	</tr>	
	<tr>
