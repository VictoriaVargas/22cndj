...
<html lang="en">
    ...
    <body>
        <div id="app">
                                    ...
                                    <div class="panel-body">
                                        <table id="data-table" class="table table-striped table-bordered">
                                            ...
                                            if ($alumnos->num_rows()>0){ 
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <i onclick="loadData('<?= $alumno->id_concurso?>')" class="fa fa-eye text-primary" data-toggle="modal" data-target=".bs-preview" style="cursor: pointer;"></i>
                                                    </td>
                                                    <td><?= $alumno->nombre_sede ?></td>
                                                    <td><?= $alumno->categoria ?></td>                                                 
                                                    <td><?= $alumno->nombre_coreografia ?></td>
                                                    <td><?= $alumno->nombre ?></td>
                                                    <td><?= $alumno->telefono ?></td>
                                                    <td><?= $alumno->email ?></td>                                                                                                        
                                                    <td><?= $alumno->coreografo ?></td>
                                                    <td><?= $alumno->musica ?></td>
                                                    <td><?= $alumno->nombre1 ?> <? if ($alumno->nombre2){ echo "&&".$alumno->nombre2; } ?> </td> 
                                                    <td>
                                                        <?if ($alumno->status_asistencia==1) { ?>
            ...
            <!-- start: FOOTER -->
                ...
                <div class="row">
                    ...
                    <div class="modal fade modal-aside vertical top bs-preview"  tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog modal-sm">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">CONCURSO :: <?= $sede->nombre_sede?></h4>
                                </div>
        ...
        <script>
            ...
            function loadData(id_concurso){
                $(".modal-body").load("<?= base_url();?>JazzAdmin/alumno_concurso/", {'id_concurso':id_concurso});
