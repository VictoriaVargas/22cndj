                                    ...
                                    <div class="panel-body">
                                        <table id="data-table" class="table table-striped table-bordered">
                                            ...
                                            if ($alumnos->num_rows()>0){ 
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <i onclick="loadData('<?= $alumno->token_qr?>')" class="fa fa-eye text-primary" data-toggle="modal" data-target=".bs-preview" style="cursor: pointer;"></i>
                                                    </td>
                                                    <td><?php echo $alumno->id_alumno ?></td>
                                                    <td><?= $alumno->nombre." ".$alumno->paterno." ".$alumno->materno; ?></td>                                                    
                                                    <td>
                                                        <?if ($alumno->status_asistencia==0) { ?>               
                                                        <a href="<?= base_url()?>Asistencia/asiste_admin_alumno/<?= $alumno->token_qr ?>/<?= $alumno->id_sede ?>"><i class="fa fa-close" style="color:red" ></i></span>                                                        
                                                        <? } 
                                                        else{ ?>
                                                        <a href="<?= base_url()?>Asistencia/asiste_admin_alumno/<?= $alumno->token_qr ?>/<?= $alumno->id_sede ?>"<i class="fa fa-check" style="color:green"></i> (<?= ($alumno->status_asistencia) ?>)</a>                                                        
                                                        <? } ?>
                                                    </td>   
                                                    <td>
                                                        <?
                                                        if (($alumno->status_constancia) ==1){?>
                                                            <a href="<?= base_url('JazzAdmin/DatosConstancia/'.$alumno->token_qr)?>"><i class="fa fa-star"></i></a>
                                                        <? }else{ ?>
                                                            <a href="<?= base_url('JazzAdmin/DatosConstancia/'.$alumno->token_qr)?>"><i class="fa fa-star-o"></i></a>
                                                        <? } ?>
                                                    </td>      
                                                    <td>
                                                        <?
                                                        if (($alumno->status_dueto) ==1){?>
                                                            <a href="<?= base_url('JazzAdmin/DatosDueto/'.$alumno->token_qr)?>"><i class="fa fa-bookmark"></i></a>
                                                        <? }else{ ?>
                                                            <a href="<?= base_url('JazzAdmin/DatosDueto/'.$alumno->token_qr)?>"><i class="fa fa-bookmark-o"></i></a>
                                                        <? } ?>
                                                    </td>                                                    
                                                    <td>
                                                        <?
                                                        if (($alumno->status_12_concurso) ==1){?>
                                                            <a href="<?= base_url('JazzAdmin/DatosConcurso/'.$alumno->token_qr)?>"><i class="fa fa-file"></i></a>
                                                        <? }else{ ?>
                                                            <a href="<?= base_url('JazzAdmin/DatosConcurso/'.$alumno->token_qr)?>"><i class="fa fa-file-o"></i></a>
                                                        <? } ?>                                                        
                                                    </td>   
                                                    ...
                                                    <td><?= $alumno->estado ?></td>
                                                    <td><?= $alumno->email ?></td>
                                                    <td><?= $alumno->academia ?></td>                                
                                                    <td><?= $alumno->talla_playera ?></td>                                
                                                    <td><?= $alumno->nivel ?></td>
                                                    <td><?= $alumno->deposito ?></td>
                                                    <td><?= $alumno->fecha_pago ?></td>
                                                    <td><?= $alumno->lugar_pago ?></td>
                                                    <td><?= $alumno->forma_pago ?></td>  
                                            ...
                                            <tr>
                                                    <td colspan="16" align="center"> No hay alumnos registrados en esta sede </td>
                                            </tr>
                                            <? } ?> 
                                            <tfoot>
                                                    <th></th>
