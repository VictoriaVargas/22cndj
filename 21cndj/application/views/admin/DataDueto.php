                        ...
                        <section id="page-title">
                            <div class="row">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">
                                        <span>Concurso de Duetos y Solos</span>
                                    </li>                                                                        
                                </ol>
                            </div>
                        </section>
                                ...
                                <div class="panel panel-white no-radius text-center">
                                    <div class="panel-body">                                       
                                        <div class="container-fluid container-fullw">
                                            ...
                                            <form action="<?= base_url()?>/JazzAdmin/EditDatosDueto" id="editdatos" method="POST">
                                                ...
                                                <input type="text" name="lugar" value="<?= $alumno->lugar_dueto?>">
                                                <h5 class="over-title margin-top-15"><span class="text-bold">Categoria:</span></h5>
                                                <input type="text" name="categoria" value="<?= $alumno->categoria_dueto?>">                                                                                                
                                            ...
                                            <div class="margin-top-15">                                                
                                                ...
                                                <a class="btn btn-wide btn-primary" target="_blank" href="<?= base_url()?>JazzAdmin/DiplomaDueto/<?= $alumno->token_qr?>"><i class="fa fa-search"></i> Ver Diploma Dueto</a>
                                                <a class="btn btn-wide btn-primary" target="_blank" href="<?= base_url()?>JazzAdmin/sendDiplomaDueto/<?= $alumno->token_qr?>"><i class="fa fa-envelope" ></i> Enviar Diploma</a>
                                            </div>
