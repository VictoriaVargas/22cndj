                                ...
                                <div class="panel panel-white no-radius text-center">
                                    <div class="panel-body">                                       
                                        <div class="container-fluid container-fullw">
                                            ...
                                            <h1>12 Concurso Nacional : 
                                                <? if ($alumno->status_dueto==0) {?>
                                            ...
                                            <form action="<?= base_url()?>/JazzAdmin/EditDatosConcurso" id="editdatos" method="POST">
                                                ...
                                                <h5 class="over-title margin-top-15"><span class="text-bold">Lugar:</span></h5>
                                                <input type="text" name="lugar" value="<?= $alumno->lugar_concurso?>">
                                                <h5 class="over-title margin-top-15"><span class="text-bold">Categoria:</span></h5>
                                                <input type="text" name="categoria" value="<?= $alumno->categoria_concurso?>">                                                                                                
                                            ...
                                            <div class="margin-top-15">                                                
                                                ...
                                                <a class="btn btn-wide btn-primary" target="_blank" href="<?= base_url()?>JazzAdmin/DiplomaConcurso/<?= $alumno->token_qr?>"><i class="fa fa-search"></i> Ver constancia</a>
                                                <a class="btn btn-wide btn-primary" target="_blank" href="<?= base_url()?>JazzAdmin/sendDiplomaConcurso/<?= $alumno->token_qr?>"><i class="fa fa-envelope" ></i> Enviar Diploma 12 Concurso</a>
                                            </div>
