...
<html lang="en">
    ...
    <head>
        ...
        <!-- end: MAIN CSS -->
        <!-- start: CLIP-TWO CSS -->
        <link rel="stylesheet" href="<?= base_url()?>assets/css/styles.css?id=1">
                ...
                <div class="main-content" >
                    <div class="wrap-content container" id="container">
                        ...
                        <section id="page-title">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h1 class="mainTitle">22Congreso Nacional de Danza Jazz 2018</h1>
                                    <span class="mainDescription">Registro de grupos y alumnos</span>
                                </div>
                                <ol class="breadcrumb">
                                    <li>
                                        <span>Inicio</span>
                                ...
                                <div class="col-sm-4">
                                    <div class="panel panel-white no-radius text-center">
                                        <div class="panel-body">
                                            <? if ($sede->id_sede==2){?>
                                            <div class="btn btn-info" style="position: absolute;right:0;top: -10px;"> 3 nuevos</div>
                                            <?}?>
                                            <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-university fa-stack-1x fa-inverse"></i> </span>
                                            <h2 class="StepTitle"><?= $sede->nombre_sede?></h2>
                                            <p class="text-small">
                                                <?= $sede->fecha ?>
                                            </p>
                                            ...
                                            <p class="links cl-effect-1">
                                                <a href="<?= base_url()?>JazzAdmin/sede/<?= $sede->id_sede?>">
                                                    ver más..
                                                </a>
                                            </p>
                                        </div>
