					...
					<nav>						
						...
						<ul class="folders">
							<li style="text-align: center;">
								<img src="<?= base_url()?>assets/img/logo.jpg" width="150px">
							</li>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-10">
									<h1 class="mainTitle"><span><img src="<?php base_url()?>assets/img/logo.jpg" width="40px"></span> Registro </h1>
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-6 text-center">
									<a href="<?= base_url()?>Inicio/individual" style="font-size: 2em">
									Registro Individual<br>
									<i class="fa fa-user margin-top-20" style="font-size: 6em"></i>
									</a>

								</div>
								<div class="col-md-6 margi">
									<div class="text-center">
									<a href="<?= base_url()?>Inicio/grupal" style="font-size: 2em">
									Registro de Grupos<br>
									<i class="fa fa-group margin-top-20" style="font-size: 6em"></i>
									</a>
									</div>
								</div>
